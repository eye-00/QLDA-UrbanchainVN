...
| Hạng mục | Giá trị |
|---|---:|
| Tổng user stories | 690 |
| Tổng sprint | 8 |
| Số epic | 15 |
| Số agent phụ trách sau bổ sung | 13 |
| ID đầu/cuối | US-001 → US-690 |
...
| Epic 15: Quản lý phiên bản & ký số tài liệu | 48 |
...
## Bổ sung chức năng: Quản lý phiên bản tài liệu và ký số tài liệu

> Bổ sung trên nền chức năng upload tài liệu/IPFS hiện có. Mục tiêu là quản lý vòng đời tài liệu theo từng phiên bản, khóa phiên bản theo hồ sơ, ký/xác minh tài liệu và ghi nhận hash/chữ ký quan trọng lên blockchain.

### Cập nhật tổng quan

| Hạng mục | Giá trị sau bổ sung |
|---|---:|
| Tổng user stories sau bổ sung | 690 |
| User stories mới | 48 |
| Epic bổ sung | Epic 15: Quản lý phiên bản & ký số tài liệu |
| ID bổ sung | US-643 → US-690 |

### Epic 15: Quản lý phiên bản & ký số tài liệu

#### Mục tiêu

- Mỗi lần upload/thay thế tài liệu tạo một phiên bản mới, không ghi đè bản cũ.
- Mỗi phiên bản có CID, file hash, metadata, trạng thái và audit log riêng.
- Khi hồ sơ được gửi/duyệt, hệ thống khóa đúng phiên bản tài liệu dùng trong quy trình.
- Hỗ trợ ký số ở mức mô phỏng MVP và/hoặc ký hash bằng ví blockchain đã liên kết.
- Chỉ ghi hash/CID/chữ ký hoặc bằng chứng xác thực lên blockchain, không lưu nội dung tài liệu nhạy cảm on-chain.

#### Trạng thái phiên bản tài liệu gợi ý
...
- signer_user_id
- signer_role
- signature_type: MOCK_DIGITAL_SIGNATURE / WALLET_SIGNATURE / EXTERNAL_CA
- signer_wallet_address
- signed_payload_hash
- signature_value
- signature_status: VALID / INVALID / REVOKED / EXPIRED
- signed_at
- verified_at
- verified_by

document_blockchain_records
- id
- document_version_id
...
GET  /api/v1/document-versions/:versionId
...
POST /api/v1/document-versions/:versionId/verify-signature
POST /api/v1/document-versions/:versionId/record-on-chain
GET  /api/v1/applications/:applicationId/document-timeline
```
...
| Sprint | Nội dung bổ sung |
|---|---|
| Sprint 2 | Tạo phiên bản tài liệu khi upload/thay thế, lưu CID/hash theo từng phiên bản |
| Sprint 3 | Lịch sử phiên bản, khóa phiên bản khi gửi/duyệt hồ sơ |
| Sprint 4 | Ký số mô phỏng và ký tài liệu bằng ví blockchain |
| Sprint 5 | Xác minh chữ ký và tính toàn vẹn tài liệu |
| Sprint 7 | Ghi nhận hash/chữ ký tài liệu lên blockchain, dashboard quản trị và báo cáo |

### Sprint 2 - Backlog bổ sung

#### Feature: Tạo phiên bản tài liệu khi upload hoặc thay thế

| ID | As a [who] | I want [what] | so that [why] | Ưu tiên | Agent | Acceptance Criteria |
|---|---|---|---|---|---|---|
| US-643 | Người dân | tải lên phiên bản mới của tài liệu đã nộp | tôi có thể sửa hồ sơ mà không làm mất bản cũ | Rất Cao | AI_06 (Database & IPFS) | 1. Chức năng "Tạo phiên bản tài liệu khi upload hoặc thay thế" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-644 | Hệ thống | tự động tăng số phiên bản tài liệu khi có file thay thế | lịch sử tài liệu được quản lý nhất quán | Rất Cao | AI_06 (Database & IPFS) | 1. Chức năng "Tạo phiên bản tài liệu khi upload hoặc thay thế" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-645 | Hệ thống | lưu CID, hash và metadata riêng cho từng phiên bản | mỗi phiên bản đều có thể kiểm chứng độc lập | Rất Cao | AI_06 (Database & IPFS) | 1. Chức năng "Tạo phiên bản tài liệu khi upload hoặc thay thế" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-646 | Hệ thống | đánh dấu phiên bản hiện hành của từng loại tài liệu | cán bộ luôn xem đúng bản mới nhất khi xử lý | Rất Cao | AI_06 (Database & IPFS) | 1. Chức năng "Tạo phiên bản tài liệu khi upload hoặc thay thế" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-647 | Hệ thống | ghi nhật ký tạo phiên bản tài liệu | có thể truy vết ai đã thay đổi tài liệu và khi nào | Cao | AI_06 (Database & IPFS) | 1. Chức năng "Tạo phiên bản tài liệu khi upload hoặc thay thế" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-648 | Người dân | nhận thông báo khi phiên bản tài liệu mới được lưu thành công | tôi biết hồ sơ đã cập nhật đúng | Cao | AI_06 (Database & IPFS) | 1. Chức năng "Tạo phiên bản tài liệu khi upload hoặc thay thế" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |

### Sprint 3 - Backlog bổ sung

#### Feature: Lịch sử và so sánh phiên bản tài liệu

| ID | As a [who] | I want [what] | so that [why] | Ưu tiên | Agent | Acceptance Criteria |
|---|---|---|---|---|---|---|
| US-649 | Người dân | xem danh sách các phiên bản của tài liệu trong hồ sơ | tôi biết mình đã từng nộp những bản nào | Cao | AI_07 (Frontend Citizen) | 1. Chức năng "Lịch sử và so sánh phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-650 | Cán bộ tiếp nhận | xem lịch sử thay đổi tài liệu theo thời gian | tôi có thể đánh giá quá trình bổ sung hồ sơ | Cao | AI_07 (Frontend Citizen) | 1. Chức năng "Lịch sử và so sánh phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-651 | Hệ thống | hiển thị thông tin phiên bản gồm số phiên bản, người tải, thời gian, CID và hash | người dùng có đủ căn cứ kiểm tra tài liệu | Cao | AI_07 (Frontend Citizen) | 1. Chức năng "Lịch sử và so sánh phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-652 | Cán bộ | so sánh metadata giữa hai phiên bản tài liệu | tôi phát hiện thay đổi quan trọng trước khi duyệt | Trung Bình | AI_07 (Frontend Citizen) | 1. Chức năng "Lịch sử và so sánh phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-653 | Hệ thống | ẩn nội dung nhạy cảm của phiên bản cũ với người không có quyền | dữ liệu cá nhân được bảo vệ | Rất Cao | AI_07 (Frontend Citizen) | 1. Chức năng "Lịch sử và so sánh phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-654 | Nhóm QA | kiểm thử lịch sử phiên bản với nhiều lần thay thế tài liệu | nhóm đảm bảo không mất dữ liệu cũ | Cao | AI_07 (Frontend Citizen) | 1. Chức năng "Lịch sử và so sánh phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |

#### Feature: Khóa phiên bản tài liệu khi gửi và duyệt hồ sơ

| ID | As a [who] | I want [what] | so that [why] | Ưu tiên | Agent | Acceptance Criteria |
|---|---|---|---|---|---|---|
| US-655 | Hệ thống | khóa phiên bản tài liệu được dùng tại thời điểm người dân gửi hồ sơ | cán bộ xử lý đúng bộ hồ sơ đã nộp | Rất Cao | AI_04 (Backend API) | 1. Chức năng "Khóa phiên bản tài liệu khi gửi và duyệt hồ sơ" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-656 | Cán bộ tiếp nhận | biết phiên bản nào là phiên bản đang được thẩm định | tôi tránh nhầm lẫn giữa bản nháp và bản đã gửi | Rất Cao | AI_04 (Backend API) | 1. Chức năng "Khóa phiên bản tài liệu khi gửi và duyệt hồ sơ" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-657 | Hệ thống | không cho thay thế tài liệu đã bị khóa trừ khi có yêu cầu bổ sung | quy trình xử lý hồ sơ không bị thay đổi ngầm | Rất Cao | AI_04 (Backend API) | 1. Chức năng "Khóa phiên bản tài liệu khi gửi và duyệt hồ sơ" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-658 | Cán bộ | mở yêu cầu bổ sung tài liệu tạo ra phiên bản mới | người dân có thể sửa đúng tài liệu được yêu cầu | Cao | AI_04 (Backend API) | 1. Chức năng "Khóa phiên bản tài liệu khi gửi và duyệt hồ sơ" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-659 | Hệ thống | lưu trạng thái phiên bản: DRAFT, SUBMITTED, UNDER_REVIEW, APPROVED, SUPERSEDED, REJECTED | vòng đời tài liệu được quản lý rõ ràng | Rất Cao | AI_04 (Backend API) | 1. Chức năng "Khóa phiên bản tài liệu khi gửi và duyệt hồ sơ" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-660 | Hệ thống | ghi audit log khi phiên bản bị khóa, mở khóa hoặc thay thế | mọi thay đổi quan trọng đều có dấu vết | Cao | AI_04 (Backend API) | 1. Chức năng "Khóa phiên bản tài liệu khi gửi và duyệt hồ sơ" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |

### Sprint 4 - Backlog bổ sung

#### Feature: Ký số tài liệu ở mức mô phỏng MVP

| ID | As a [who] | I want [what] | so that [why] | Ưu tiên | Agent | Acceptance Criteria |
|---|---|---|---|---|---|---|
| US-661 | Người dân | ký xác nhận tài liệu hồ sơ bằng chữ ký số mô phỏng | tôi xác nhận trách nhiệm với tài liệu đã nộp | Cao | AI_04 (Backend API) | 1. Chức năng "Ký số tài liệu ở mức mô phỏng MVP" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-662 | Cán bộ | ký xác nhận kết quả kiểm tra tài liệu | hồ sơ có dấu vết phê duyệt rõ ràng | Cao | AI_04 (Backend API) | 1. Chức năng "Ký số tài liệu ở mức mô phỏng MVP" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-663 | Hệ thống | tạo signature payload gồm documentVersionId, fileHash, signerId và timestamp | chữ ký gắn chặt với đúng phiên bản tài liệu | Rất Cao | AI_04 (Backend API) | 1. Chức năng "Ký số tài liệu ở mức mô phỏng MVP" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-664 | Hệ thống | lưu chữ ký số mô phỏng tách biệt với file gốc | dữ liệu ký có thể kiểm tra lại mà không sửa file | Cao | AI_04 (Backend API) | 1. Chức năng "Ký số tài liệu ở mức mô phỏng MVP" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-665 | Hệ thống | không cho ký tài liệu nếu phiên bản chưa được khóa hoặc hash không khớp | tránh ký nhầm tài liệu | Rất Cao | AI_04 (Backend API) | 1. Chức năng "Ký số tài liệu ở mức mô phỏng MVP" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-666 | Người ký | nhận thông báo kết quả ký thành công hoặc thất bại | tôi biết thao tác ký đã được hệ thống ghi nhận | Cao | AI_04 (Backend API) | 1. Chức năng "Ký số tài liệu ở mức mô phỏng MVP" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |

#### Feature: Ký tài liệu bằng ví blockchain

| ID | As a [who] | I want [what] | so that [why] | Ưu tiên | Agent | Acceptance Criteria |
|---|---|---|---|---|---|---|
| US-667 | Người dân | ký hash tài liệu bằng ví blockchain đã liên kết | tôi chứng minh mình sở hữu ví và đã xác nhận tài liệu | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ký tài liệu bằng ví blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-668 | Cán bộ phê duyệt | ký hash phiên bản tài liệu khi phê duyệt hồ sơ | hệ thống có bằng chứng xác nhận từ đúng vai trò | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ký tài liệu bằng ví blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-669 | Hệ thống | xác minh chữ ký ví khớp với địa chỉ ví đã liên kết tài khoản | ngăn người khác ký thay trái phép | Rất Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ký tài liệu bằng ví blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-670 | Hệ thống | lưu walletSignature, signerAddress và signedMessageHash | chữ ký có thể được kiểm chứng lại | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ký tài liệu bằng ví blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-671 | Hệ thống | ghi event xác nhận ký tài liệu lên blockchain khi cần | lịch sử ký quan trọng có khả năng chống sửa đổi | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ký tài liệu bằng ví blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-672 | Smart Contract Auditor | kiểm tra không đưa nội dung tài liệu nhạy cảm vào message ký hoặc event on-chain | dữ liệu pháp lý không bị công khai ngoài ý muốn | Rất Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ký tài liệu bằng ví blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |

### Sprint 5 - Backlog bổ sung

#### Feature: Xác minh chữ ký và tính toàn vẹn tài liệu

| ID | As a [who] | I want [what] | so that [why] | Ưu tiên | Agent | Acceptance Criteria |
|---|---|---|---|---|---|---|
| US-673 | Cán bộ thẩm định | kiểm tra chữ ký và hash của tài liệu trước khi duyệt | tôi biết tài liệu chưa bị thay đổi sau khi ký | Rất Cao | AI_15 (Compliance) | 1. Chức năng "Xác minh chữ ký và tính toàn vẹn tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-674 | Hệ thống | so sánh fileHash hiện tại với fileHash đã ký | phát hiện tài liệu bị thay đổi sau ký | Rất Cao | AI_15 (Compliance) | 1. Chức năng "Xác minh chữ ký và tính toàn vẹn tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-675 | Hệ thống | hiển thị trạng thái chữ ký: unsigned, signed, invalid, expired, revoked | người dùng hiểu tình trạng pháp lý kỹ thuật của tài liệu | Cao | AI_15 (Compliance) | 1. Chức năng "Xác minh chữ ký và tính toàn vẹn tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-676 | Cán bộ | xem thông tin người ký, thời gian ký và phương thức ký | tôi có căn cứ thẩm định hồ sơ | Cao | AI_15 (Compliance) | 1. Chức năng "Xác minh chữ ký và tính toàn vẹn tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-677 | Hệ thống | ghi cảnh báo khi chữ ký không hợp lệ hoặc hash không khớp | hồ sơ rủi ro không được duyệt nhầm | Rất Cao | AI_15 (Compliance) | 1. Chức năng "Xác minh chữ ký và tính toàn vẹn tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-678 | Nhóm QA | kiểm thử các trường hợp chữ ký hợp lệ, sai signer, sai hash và tài liệu bị thay thế | nhóm đảm bảo xác minh chữ ký hoạt động đúng | Cao | AI_15 (Compliance) | 1. Chức năng "Xác minh chữ ký và tính toàn vẹn tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |

### Sprint 7 - Backlog bổ sung

#### Feature: Ghi nhận hash/chữ ký tài liệu lên blockchain

| ID | As a [who] | I want [what] | so that [why] | Ưu tiên | Agent | Acceptance Criteria |
|---|---|---|---|---|---|---|
| US-679 | Hệ thống | ghi nhận documentVersionHash lên blockchain sau khi tài liệu được phê duyệt | phiên bản tài liệu quan trọng có thể kiểm chứng lâu dài | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ghi nhận hash/chữ ký tài liệu lên blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-680 | Hệ thống | liên kết transactionHash với documentVersionId trong database | frontend và cán bộ có thể tra cứu bằng chứng blockchain | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ghi nhận hash/chữ ký tài liệu lên blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-681 | Hệ thống | phát event DocumentVersionRecorded khi ghi nhận hash tài liệu | backend có thể đồng bộ trạng thái ghi blockchain | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ghi nhận hash/chữ ký tài liệu lên blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-682 | Cán bộ | xem trạng thái đã ghi blockchain của từng phiên bản tài liệu | tôi biết tài liệu nào đã được cố định bằng blockchain | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ghi nhận hash/chữ ký tài liệu lên blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-683 | Smart Contract Auditor | kiểm tra contract chỉ lưu hash/CID cần thiết, không lưu file hoặc PII | hệ thống giảm rủi ro lộ dữ liệu | Rất Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ghi nhận hash/chữ ký tài liệu lên blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-684 | Nhóm QA | kiểm thử ghi hash tài liệu trên local chain/testnet | nhóm có bằng chứng nghiệm thu chức năng blockchain | Cao | AI_02 (Blockchain Core Dev) | 1. Chức năng "Ghi nhận hash/chữ ký tài liệu lên blockchain" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |

#### Feature: Quản trị chữ ký số và báo cáo phiên bản tài liệu

| ID | As a [who] | I want [what] | so that [why] | Ưu tiên | Agent | Acceptance Criteria |
|---|---|---|---|---|---|---|
| US-685 | Cán bộ quản trị | xem danh sách tài liệu đã ký và chưa ký theo hồ sơ | tôi kiểm soát tiến độ hoàn thiện hồ sơ | Cao | AI_08 (Frontend Admin) | 1. Chức năng "Quản trị chữ ký số và báo cáo phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-686 | Cán bộ compliance | lọc tài liệu theo trạng thái chữ ký và phiên bản | tôi dễ phát hiện hồ sơ có rủi ro | Cao | AI_08 (Frontend Admin) | 1. Chức năng "Quản trị chữ ký số và báo cáo phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-687 | Hệ thống | xuất báo cáo lịch sử phiên bản và chữ ký của một hồ sơ | nhóm có bằng chứng phục vụ kiểm tra và bảo vệ đồ án | Cao | AI_08 (Frontend Admin) | 1. Chức năng "Quản trị chữ ký số và báo cáo phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-688 | Cán bộ | xem timeline gồm upload, tạo phiên bản, khóa, ký, duyệt và ghi blockchain | tôi hiểu toàn bộ vòng đời tài liệu | Cao | AI_08 (Frontend Admin) | 1. Chức năng "Quản trị chữ ký số và báo cáo phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-689 | Hệ thống | phân quyền thao tác ký, hủy ký, xác minh và xem lịch sử ký | mỗi vai trò chỉ dùng đúng chức năng được phép | Rất Cao | AI_08 (Frontend Admin) | 1. Chức năng "Quản trị chữ ký số và báo cáo phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
| US-690 | Nhóm QA | kiểm thử dashboard chữ ký tài liệu với nhiều vai trò | nhóm đảm bảo không lộ hoặc sai dữ liệu | Cao | AI_08 (Frontend Admin) | 1. Chức năng "Quản trị chữ ký số và báo cáo phiên bản tài liệu" xử lý đúng phiên bản/hash/chữ ký liên quan. 2. Có audit log và thông báo rõ ràng khi thao tác thành công hoặc thất bại. |
