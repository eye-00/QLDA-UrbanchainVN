...
Quy tắc triển khai nghiệp vụ:
- Quy trình actor phải bám phân định thẩm quyền 2 cấp.
- Nếu phát sinh phí/lệ phí: ghi nhận tại cơ quan tiếp nhận theo quy định.
- Nghĩa vụ tài chính và biên nhận xử lý off-chain; on-chain chỉ lưu bằng chứng hash/CID/tx.
- Bước ghi blockchain chỉ chạy sau cập nhật hồ sơ địa chính/CSDL đất đai.
