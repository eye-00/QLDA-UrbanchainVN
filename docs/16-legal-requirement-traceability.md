...
| -------------- | -------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ---------------------------- | ---------- | ----------------- |
| 151/2025/NĐ-CP | Điều 2                     | Phân định thẩm quyền chính quyền địa phương 2 cấp                                         | Routing actor theo role trong workflow                                          | `05`, `08`, `09`, `07`       | Done       | No                |
| 151/2025/NĐ-CP | Điều 3                     | Khi nộp hồ sơ có phí/lệ phí thì thu tại cơ quan tiếp nhận                                 | Intake fee + payment obligation model                                           | `05`, `07`, `09`             | Done       | No                |
| 151/2025/NĐ-CP | Điều 5-9                   | Chuyển thẩm quyền từ cấp huyện sang cấp xã/cấp tỉnh theo quy định                         | Authority matrix theo thủ tục                                                   | `05`, `08`, `09`, `07`       | Done       | No                |
...
| 2304/QĐ-BNNMT  | Danh mục TTHC nền          | Nguồn danh mục nền cho thủ tục đất đai                                                    | Procedure catalog baseline                                                      | `00`, `07`, `04`             | Done       | No                |
| 3380/QĐ-BNNMT  | Danh mục TTHC mới/sửa đổi  | Ưu tiên nội dung thủ tục mới/sửa đổi so với 2304                                          | Procedure override + legal basis mapping                                        | `00`, `07`, `05`             | Done       | No                |
| 3380 + 151     | Theo thủ tục áp dụng       | Actor xử lý có thể gồm UBND xã, cơ quan chuyên môn cấp xã, VPĐKĐĐ/Chi nhánh, cơ quan thuế | Workflow duyệt hồ sơ đăng ký lần đầu                                            | `05`, `09`, `08`             | Done       | No                |
...
| 151 + 3380     | Theo TTHC cụ thể           | Transition nhạy cảm phải có căn cứ pháp lý, actor và bằng chứng                           | Transition endpoint với `procedureCode`, `legalBasisCode`, `reason`, `evidence` | `07`, `05`, `09`             | Done       | No                |
...
| ------------------------------------- | ------------------- | ---------- |
| Đăng ký lần đầu                       | 151 + 3380 + 101    | Done       |
| Duyệt hồ sơ                           | 151 + 3380          | Done       |
| Nghĩa vụ tài chính                    | 151                 | Done       |
...
Ghi chú closeout Sprint 2:

- `LEG-S2-001..005` đã có evidence code/test/docs và được xem là `Done` ở mức Sprint 2.
- `LEG-S3-001..003` da duoc dong bang evidence code/test/docs cho luong review ho so dang ky lan dau.
- Các dòng còn `Partial` ở bảng trên là phần phụ thuộc Sprint 4/5 hoặc legal sign-off ngoài phạm vi Sprint 3.
