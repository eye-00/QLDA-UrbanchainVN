...
Theo bo tai lieu `docs/docs-legal-aligned`, trang thai closure sprint duoc cap nhat lai nhu sau:

| Sprint   | Trang thai truoc legal rebaseline | Trang thai sau legal rebaseline | Ly do                                                                                            |
| -------- | --------------------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------ |
...
| Gap                                         | Mo ta                                                                                                                        | Backlog legal item         | Owner chinh                          | Uu tien                         |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ------------------------------------ | ------------------------------- |
...
## 2.2. Technical closure update (2026-05-17)
...
- Smoke local gate pass (2026-05-17):
  - `npm run db:generate`
  - `npm run db:migrate`
  - `npm run db:seed`
  - `npm run lint`
...
- PowerShell local duoc chuan hoa qua wrapper `scripts/npmw.ps1` va `scripts/dev.ps1` de tranh loi resolve `npm.ps1` va loi seed thieu `backend/.env`.
...
Bang chung closeout Sprint 3 tren `develop`:

- Backend review-flow legal evidence:
  - [backend/test/sprint3-registration.test.ts](../backend/test/sprint3-registration.test.ts) (`8/8` pass)
  - [backend/src/modules/registrations/registration.routes.ts](../backend/src/modules/registrations/registration.routes.ts)
- Frontend legal UX evidence:
...
- Gate verify bo sung ngay `2026-05-17`:
...
### Sprint 1 closure update (2026-05-10)

Sau khi merge chuỗi PR wallet Sprint 1 và chạy smoke test trên `develop` mới nhất:

- [PR #6](https://github.com/eye-00/QLDA-UrbanchainVN/pull/6) (backend/db/auth/test) da merge, merge commit `89c85ed`.
- [PR #7](https://github.com/eye-00/QLDA-UrbanchainVN/pull/7) (frontend/docs) da merge, merge commit `e8605bf`.
- Smoke local pass:
  - `npm run db:generate`
  - `npm run db:migrate`
  - `npm run db:seed`
  - `npm --workspace backend run test -- test/sprint1-wallet.test.ts`
  - `npm --workspace frontend run test -- test/wallet-helpers.test.ts`

Trang thai chot:

- Auth (Epic 1): `Done`
- Wallet connect + verify (Epic 13 / `US-547..558`): `Done`
- QA/Test gate (Epic 11): `Done`
- Audit/Security/Compliance (Epic 10): `Done`
...
> Historical snapshot. Trang thai sprint hien hanh phai theo section `2.1. Legal rebaseline snapshot (2026-05-10)`.
...
- Lưu ý: thong tin `Done` ben tren da phu hop legal baseline hien hanh cho Sprint 1 va Sprint 2; Sprint 3/4 van phai theo trang thai closeout o section `2.1`.
